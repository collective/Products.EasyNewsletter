...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_issue_statistics_is_registered(self):
        view = getMultiAdapter((self.issue, self.portal.REQUEST), name="statistics")
        self.assertTrue(view.__name__ == "statistics")

    def test_issue_statistics_not_matching_interface(self):
        with self.assertRaises(ComponentLookupError):
            getMultiAdapter((self.portal, self.portal.REQUEST), name="statistics")
