...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_unsubscribe_is_registered(self):
        view = getMultiAdapter((self.newsletter, self.portal.REQUEST), name="unsubscribe")
        self.assertTrue(view.__name__ == "unsubscribe")
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in unsubscribe'
        # )

    def test_unsubscribe_not_matching_interface(self):
        with self.assertRaises(ComponentLookupError):
            getMultiAdapter((self.portal, self.portal.REQUEST), name="unsubscribe")
