...
It's a feature of Collections that sub topics are able to inherit criteria from 
its parent, so all Issue instances are able to inherit criteria from the 
...
5. Go to the view tab and press refresh (see the document actions)
